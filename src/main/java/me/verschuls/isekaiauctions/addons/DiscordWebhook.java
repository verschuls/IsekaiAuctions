...
public class DiscordWebhook {
    ...
    public void sendMessage(String type, PlaceholderUtil placeholderUtil) {
        ...
        ConfigurationSection section = IsekaiAuctions.getInstance().configFile.getConfigurationSection("addons.discord." + type);
        if (section == null)
            return;
    ...
    public void execute(String content) {
        ...
        new Thread(() -> {
            try {
                ...
                connection.setRequestProperty("User-Agent", "DeluxeAuctions-DiscordWebhook");
