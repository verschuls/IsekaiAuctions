...
public class ChatInput {
    ...
    public ChatInput(Player player, ChatHandler handler) {
        ...
        Bukkit.getPluginManager().registerEvents(this.listener, IsekaiAuctions.getInstance());
        this.listening = true;
        ...
        }, IsekaiAuctions.getInstance().configFile.getInt("settings.chat_input_time", 10) * 20L);
    }
